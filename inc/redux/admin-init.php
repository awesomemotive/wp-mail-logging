...
if (file_exists(dirname(__FILE__).'/../../vendor/redux-framework/redux-framework/ReduxCore/framework.php')) {
    require_once( dirname(__FILE__).'/../../vendor/redux-framework/redux-framework/ReduxCore/framework.php' );
}
