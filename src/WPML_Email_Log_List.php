...
class WPML_Email_Log_List extends \WP_List_Table implements IHooks {
    ...
    private function display_actions_icons( $email_log_id ) {
        ...
        $view_title   = sprintf(
            /*
             * translators: %d: Email Log ID to view.
             */
            __( 'View log #%d', 'wp-mail-logging' ),
            $email_log_id
        );
        $resend_title = sprintf(
            /*
             * translators: %d: Email Log ID to resend.
             */
            __( 'Resend log #%d', 'wp-mail-logging' ),
            $email_log_id
        );
        $delete_title = sprintf(
            /*
             * translators: %d: Email Log ID to delete.
             */
            __( 'Delete log #%d', 'wp-mail-logging' ),
            $email_log_id
        );

        return '<div class="wp-mail-logging-action-column" data-mail-id="' . esc_attr( $email_log_id )  . '">
            <button title="' . esc_attr( $view_title ) . '" class="wp-mail-logging-action-item" data-action="view">
            ...
            <button title="' . esc_attr( $resend_title ) . '" class="wp-mail-logging-action-item" data-action="resend">
                 <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <button title="' . esc_attr( $delete_title ) . '" class="wp-mail-logging-action-item"  data-action="delete">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
