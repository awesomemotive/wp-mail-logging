...
class WPML_LogRotation implements IHooks {
    ...
    public function init() {
        ...
        if ( true == $wpml_settings['log-rotation-limit-amout'] || true == $wpml_settings['log-rotation-delete-time'] ) {
            $this->schedule();
        } else {
            $this->unschedule();
        }
    ...
    static function limitNumberOfMailsByAmount() {
        ...
        if ( true == $wpml_settings['log-rotation-limit-amout'] ) {
    ...
    static function limitNumberOfMailsByTime() {
        ...
        if ( true == $wpml_settings['log-rotation-delete-time'] ) {
